...
var attributions_svelte_svelte_type_style_lang = /* @__PURE__ */ (() => "div.svelte-14spxn5{font-size:10pt;color:gray;margin:10px 0px}p.svelte-14spxn5{margin:2px 0px}a.svelte-14spxn5{color:gray}")();
const css$1 = {
...
const Attributions = (0, import_index_0fac4578.c)(($$result, $$props, $$bindings, slots) => {
...
const Press = (0, import_index_0fac4578.c)(($$result, $$props, $$bindings, slots) => {
  let { size = 100 } = $$props;
  ...
  return `<svg xmlns="${"http://www.w3.org/2000/svg"}"${(0, import_index_0fac4578.a)("width", size, 0)}${(0, import_index_0fac4578.a)("height", size, 0)} viewBox="${"0 0 32 32"}" xml:space="${"preserve"}"><path class="${"puchipuchi_een"}" d="${"M7 6a5 5 0 0 1 10 0 5 5 0 0 1-2 4V6a3 3 0 0 0-6 0v4a5 5 0 0 1-2-4zm17 7a2 2 0 0 0-2 2v-1a2 2 0 0 0-4 0v-1a2 2 0 0 0-4 0V6a2 2 0 0 0-4 0v10.3A2 2 0 0 0 7 18v3c0 .5.2.9.4 1.2L11 28h12l2.3-3.3c.4-.4.7-1.1.7-1.7v-8a2 2 0 0 0-2-2zM11 29v1c0 .6.4 1 1 1h10c.6 0 1-.4 1-1v-1H11z"}" style="${"fill:" + (0, import_index_0fac4578.e)(color, true)}"></path></svg>`;
});
const Spook = (0, import_index_0fac4578.c)(($$result, $$props, $$bindings, slots) => {
  let { size = 100 } = $$props;
  let { color = "#000000" } = $$props;
  if ($$props.size === void 0 && $$bindings.size && size !== void 0)
    $$bindings.size(size);
  if ($$props.color === void 0 && $$bindings.color && color !== void 0)
    $$bindings.color(color);
  return `<svg xmlns="${"http://www.w3.org/2000/svg"}"${(0, import_index_0fac4578.a)("width", size, 0)}${(0, import_index_0fac4578.a)("height", size, 0)} viewBox="${"0 0 32 32"}" xml:space="${"preserve"}"><path class="${"puchipuchi_een"}" d="${"M16 2C9.925 2 5 6.925 5 13v15a2 2 0 1 0 4 0v-1a1 1 0 0 1 2 0v1a2 2 0 1 0 4 0v-1a1 1 0 0 1 2 0v1a2 2 0 1 0 4 0v-1a1 1 0 0 1 2 0v1a2 2 0 1 0 4 0V13c0-6.075-4.925-11-11-11zm-3 14a2 2 0 1 1-.001-3.999A2 2 0 0 1 13 16zm6 0a2 2 0 1 1-.001-3.999A2 2 0 0 1 19 16zm-5-2a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm6 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0z"}" style="${"fill:" + (0, import_index_0fac4578.e)(color, true)}"></path></svg>`;
});
const Wand = (0, import_index_0fac4578.c)(($$result, $$props, $$bindings, slots) => {
  let { size = 100 } = $$props;
  let { color = "#000000" } = $$props;
  if ($$props.size === void 0 && $$bindings.size && size !== void 0)
    $$bindings.size(size);
...
const Moon = (0, import_index_0fac4578.c)(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.color === void 0 && $$bindings.color && color !== void 0)
    $$bindings.color(color);
  return `<svg xmlns="${"http://www.w3.org/2000/svg"}"${(0, import_index_0fac4578.a)("width", size, 0)}${(0, import_index_0fac4578.a)("height", size, 0)} viewBox="${"0 0 32 32"}" xml:space="${"preserve"}"><path class="${"puchipuchi_een"}" d="${"M28.6 17.5a.7.7 0 0 1 1.2.7 14 14 0 1 1-16-16c.8-.1 1.2.7.7 1.2a10 10 0 0 0 14 14.1z"}" style="${"fill:" + (0, import_index_0fac4578.e)(color, true)}"></path></svg>`;
});
var index_svelte_svelte_type_style_lang = /* @__PURE__ */ (() => ":root{font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif}.main.svelte-1ofm7g7{display:flex;flex-direction:column;align-items:center;justify-content:space-around;height:100vh;margin:1em;padding:0}h1.svelte-1ofm7g7{font-size:24pt}.list.svelte-1ofm7g7{max-width:400px;display:flex;flex-direction:column;align-items:center;justify-content:center;font-size:14pt;margin:0;padding:0}")();
const css = {
...
const Routes = (0, import_index_0fac4578.c)(($$result, $$props, $$bindings, slots) => {
  ...
  <div class="${"main svelte-1ofm7g7"}"><div class="${"list svelte-1ofm7g7"}"><h1 class="${"svelte-1ofm7g7"}">The Oblique Birdhouse</h1>
      ${(0, import_index_0fac4578.v)(Svg_box, "SvgBox").$$render($$result, { inverted: true }, {}, {
    right: () => {
      return `<p slot="${"right"}">Your decisions matter. Press a <strong>SEQUENCE</strong> of buttons to get a surprise.
        </p>`;
    },
    left: () => {
      return `${(0, import_index_0fac4578.v)(Press, "Press").$$render($$result, { slot: "left", color: "white" }, {}, {})}`;
    }
  })}
      ${(0, import_index_0fac4578.v)(Svg_box, "SvgBox").$$render($$result, {}, {}, {
    right: () => {
      return `<p slot="${"right"}">Sequences starting with the ghost Clyde will make mazes.</p>`;
    },
    left: () => {
      return `${(0, import_index_0fac4578.v)(Spook, "Spook").$$render($$result, { slot: "left" }, {}, {})}`;
    }
  })}
      ${(0, import_index_0fac4578.v)(Svg_box, "SvgBox").$$render($$result, {}, {}, {
    right: () => {
    ...
    left: () => {
      return `${(0, import_index_0fac4578.v)(Wand, "Wand").$$render($$result, { slot: "left" }, {}, {})}`;
    }
  })}
      ${(0, import_index_0fac4578.v)(Svg_box, "SvgBox").$$render($$result, {}, {}, {
    right: () => {
    ...
    left: () => {
      return `${(0, import_index_0fac4578.v)(Moon, "Moon").$$render($$result, { slot: "left" }, {}, {})}`;
    }
  })}
      ${(0, import_index_0fac4578.v)(Svg_box, "SvgBox").$$render($$result, {}, {}, {
    right: () => {
    ...
    left: () => {
      return `${(0, import_index_0fac4578.v)(Yeti, "Yeti").$$render($$result, { slot: "left" }, {}, {})}`;
    }
  })}</div>
    <div class="${"list svelte-1ofm7g7"}">${(0, import_index_0fac4578.v)(Attributions, "Attribution").$$render($$result, {}, {}, {})}</div>
</div>`;
});
